// Filesystem watcher (feature #8): reflect edits made outside the app (Obsidian,
// an editor, `git pull`). A background `notify` watcher flips an atomic flag; the
// app drains it each frame and offers a reload in the References dock.
